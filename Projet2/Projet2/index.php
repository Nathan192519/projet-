...
<div class="footer">
        ...
        <div class="section-footer">
            ...
            <ul>
                <li>----Notre calendrier 2025 est là!</li>
                <li>----Prenez part à nos activités de financement</li>
                <li>----Notre calendrier 2024 est arrivé!</li>
                <li>----Une protection gratuite de 6 semaines pour les maladies et accidents!</li>
                <li>----Garde tes vides pour nos minous!</li>
            </ul>
        </div>
        <div class="don-footer">
            <p>Aidez-nous à aider les minous! Nous sommes situés dans la région de Québec.</p>
            <button onclick="window.location.href='/asset/PHP/view/don.php'">FAIRE UN DON</button>
        </div>
    </div>
    <hr>
    <?php
